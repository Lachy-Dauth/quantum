...
_Proof._ Suppose such a U exists. Then:
...
_Proof sketch._ Write the initial state as:
|psi>_1 |Phi+>_{23} = (a|0>+b|1>)_1 (|00>+|11>)_{23} / sqrt(2)

Expand, apply CNOT*{12}, apply H_1, then regroup into Bell basis on qubits 1,2:
= (1/2)[ |Phi+>*{12}(a|0>+b|1>)_3 + |Phi->_{12}(a|0>-b|1>)_3 + |Psi+>_{12}(a|1>+b|0>)_3 + |Psi->_{12}(a|1>-b|0>)\_3 ]
...
_Proof sketch._ The four Bell states are:
...
|Psi*0> = |0>\_1 tensor (|00>+|11>)*{23}/sqrt(2) = (|000>+|011>)/sqrt(2)
...
Step 0 -- Initial state:
|Psi*0> = [(|0>+|1>)/sqrt(2)]\_1 tensor [(|00>+|11>)/sqrt(2)]*{23}
= (1/2)(|000>+|011>+|100>+|111>)
